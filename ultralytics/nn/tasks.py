...
class RTDETRDetectionModel(DetectionModel):
    ...
    def loss(self, batch, preds=None):
        ...
        Args:
            batch (dict): Dictionary containing images and labels data.
    ...
    def predict(self, x, profile=False, visualize=False, batch=None, augment=False, embed=None):
        ...
        Args:
            ...
            profile (bool, optional): If True, check.py the computation time for each layer. Defaults to False.
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in {
            ...
            args = [ch[f]]
        elif m in {PPAPEMA, PoolingEMA}:
            c2 = ch[f]
            args = [c2, *args]
        elif m in {KDEHyperGraphFusion, GraphHyperGraphFusion}:
