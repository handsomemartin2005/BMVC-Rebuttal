...
def smooth_BCE(eps=0.1):
    ...
    This function calculates positive and negative labels smoothing BCE targets based on a given epsilon value.
    For implementation details, refer to https://github.com/ultralytics/yolov3/issues/238#issuecomment-598028441.

    Args:
        eps (float, optional): The epsilon value for labels smoothing. Defaults to 0.1.

    Returns:
        (tuple): A tuple containing the positive and negative labels smoothing BCE targets.
    """
...
class ConfusionMatrix:
    ...
    def plot(self, normalize=True, save_dir="", names=(), on_plot=None):
        ...
        seaborn.set_theme(font_scale=1.0 if nc < 50 else 0.8)  # for labels size
